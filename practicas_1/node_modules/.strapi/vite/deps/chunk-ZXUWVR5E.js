...
import {
  LimitsModal
} from "./chunk-U5FBU4KV.js";
import {
  AssigneeColumn,
  StageColumn,
  getDisplayName
} from "./chunk-GQYXFYF6.js";
import {
  getStageColorByHex
} from "./chunk-AN5XNJAY.js";
import {
...
} from "./chunk-UDICH6XA.js";
import {
  useTypedSelector
} from "./chunk-376K3XML.js";
import {
  ReleaseActionMenu,
  ReleaseActionOptions
} from "./chunk-OTZJOCRN.js";
import {
  index
} from "./chunk-3YQ7X2WX.js";
import {
...
} from "./chunk-3POXZL32.js";
import {
  useConfig
} from "./chunk-5ZJEUYZM.js";
import {
  AssetSource,
  AssetType,
...
import {
  useDocumentActions
} from "./chunk-4E6SMZ34.js";
import {
  buildValidParams,
  useContentManagerContext,
  useDocument,
  useDocumentLayout
} from "./chunk-GLFLENXM.js";
import {
  renderAdmin
...
var index2 = {
  register(app) {
    ...
    app.addMenuLink({
      ...
      Component: () => import("./App-HPT7DNCO.js"),
      position: 5
    });
    app.registerPlugin({
      id: pluginId,
  ...
  register(app) {
    app.createSettingSection({
    ...
    }, [
      {
        ...
        id: "settings",
        to: "email",
        Component: () => import("./Settings-SKMPJX75.js").then((mod) => ({
...
function __variableDynamicImportRuntime3__(path) {
  switch (path) {
    ...
    case "./translations/es.json":
      return import("./es.json-NNNB75RO.js");
    case "./translations/fr.json":
...
var admin2 = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => {
        return import("./App-QB2RON7J.js").then((mod) => ({
          default: mod.Upload
        }));
      },
      position: 4
    ...
    if (window.strapi.future.isEnabled("unstableMediaLibrary")) {
      ...
      app.addMenuLink({
        ...
        permissions: PERMISSIONS3.main,
        Component: () => {
          return import("./App-5OEBF65Y.js").then((mod) => ({
    ...
    app.addSettingsLink("global", {
      ...
      async Component() {
        const { ProtectedSettingsPage } = await import("./SettingsPage-4E6WRMB3.js");
        return {
...
var index3 = {
  ...
  bootstrap(app) {
    ...
    app.addSettingsLink("global", {
      ...
      Component: () => import("./SettingsPage-6RSR3IAW.js").then((mod) => ({
        default: mod.ProtectedSettingsPage
      })),
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-ABDHUE2A.js").then((mod) => ({
          default: mod.App
        })),
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { ProtectedReleasesSettingsPage } = await import("./ReleasesSettingsPage-BXJFHHIQ.js");
          return {
      ...
      app.widgets.register([
        {
          ...
          component: async () => {
            const { UpcomingReleasesWidget } = await import("./Widgets-PBN4V56M.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseContentReleases } = await import("./PurchaseContentReleases-TI5WV6DZ.js");
          return {
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { Router } = await import("./router-AKWRXG4U.js");
          return {
            default: Router
          };
        }
      ...
      app.widgets.register((widgets) => [
        ...widgets,
        {
          ...
          component: async () => {
            const { AssignedWidget } = await import("./Widgets-ET7ACTZJ.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseReviewWorkflows } = await import("./purchase-review-workflows-VNWBGMDA.js");
          return {
...
//# sourceMappingURL=chunk-ZXUWVR5E.js.map
